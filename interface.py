...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # Create initial calculator frame
        #self.add_calculator_frame()
    ...
    def add_calculator_frame(self, seed):
        ...
        entry_seed.grid(row=1, column=1, padx=2, pady=0)
        ...
        cost = customtkinter.CTkLabel(new_frame, corner_radius=5, text="cost", fg_color="grey10", text_color="white")
        cost.grid(row=0, column=3, sticky="nsew", pady=6, padx=6)
        goldday = customtkinter.CTkLabel(new_frame, text="gold per day", fg_color="grey10", text_color="white")
        goldday.grid(row=1, column=3, sticky="nsew", pady=6, padx=6)
        netincome = customtkinter.CTkLabel(new_frame, text="net income per month", fg_color="grey10", text_color="white")
        netincome.grid(row=2, column=3, sticky="nsew", pady=6, padx=6)
        grossincome = customtkinter.CTkLabel(new_frame, corner_radius=5, text="gross income per month", fg_color="grey10", text_color="white")
        grossincome.grid(row=3, column=3, sticky="nsew", pady=6, padx=6)
        ...
        equal.grid(row=1, column=2, rowspan=2, sticky="nsew")
